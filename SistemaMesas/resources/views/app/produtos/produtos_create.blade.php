            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-muted">Preencha os dados do novo produto</p>
                    </div>
                            ...
                            <form action="{{route('produto.create')}} " method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="categoria" 
                                        ...
                                        <option value="pratos" {{ old('categoria') == 'pratos' ? 'selected' : '' }}>Pratos</option>
                                        <option value="self-service" {{ old('categoria') == 'self-service' ? 'selected' : '' }}>Self-Service</option>
                                        <option value="doces" {{ old('categoria') == 'doces' ? 'selected' : '' }}>Doces</option>
                                        <option value="diversos" {{ old('categoria') == 'diversos' ? 'selected' : '' }}>Diversos</option>
                                    </select>
                                    @error('categoria')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
